...
export type ReactMarkdownProps = import('react-markdown/lib/complex-types.js').ReactMarkdownProps
export type Raw = {
  type: 'raw'
  value: string
}
...
export type Components = Partial<
  Omit<import('react-markdown/lib/complex-types.js').NormalComponents, keyof SpecialComponents> &
    SpecialComponents
>
export type Options = {
  sourcePos?: boolean
